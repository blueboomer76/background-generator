...
if (Math.random() < 0.5) {
	if (Math.random() < 0.5) {
		...
		document.body.style.color = `rgba(${colors[6]}, ${colors[7]}, ${colors[8]}, 0.8)`;
	} else {
		...
		document.body.style.color = `rgba(${colors[9]}, ${colors[10]}, ${colors[11]}, 0.8)`;
	}
} else {
...
document.body.style.color = `rgba(${textColors[0]}, ${textColors[1]}, ${textColors[2]}, 0.8)`;
